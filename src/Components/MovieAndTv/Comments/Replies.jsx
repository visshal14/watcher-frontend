...
const Replies = ({ ele, location, email, getComments, hightLightedCommentParents }) => {
    ...
    return (
        <>
            {ele?.comment_id && !ele?.isDeleted && <Grid container id={ele.comment_id} sx={{
                my: "4px",
                width: "100%",
